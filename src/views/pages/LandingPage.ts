        ...
        <div class="max-w-6xl mx-auto flex flex-col md:flex-row items-center text-center md:text-left">
          <div class="w-full md:w-1/2 mb-10 md:mb-0">
            ...
            <h1 class="text-4xl sm:text-5xl md:text-6xl font-extrabold text-gray-900 leading-tight mt-5 mb-4 md:mb-6">
              Sensasi <span class="text-red-600">Pedas Sunda</span> Bertemu <span class="text-blue-800">Kondiment asal Korea</span>
            </h1>
            <p class="text-base sm:text-lg text-gray-600 mb-8 px-2 md:px-0">
              Lupakan seblak biasa. Nikmati kenyalnya kerupuk seblak berpadu dengan tteokbokki, odeng, dan dumpling keju.
            </p>
          ...
          <div class="w-full md:w-1/2 flex justify-center mt-4 md:mt-0">
            <div class="w-64 h-64 sm:w-72 sm:h-72 md:w-96 md:h-96 bg-orange-50 rounded-full flex items-center justify-center relative shadow-2xl border-4 border-white">
              <img src="https://raw.githubusercontent.com/NeoRyumasil/MangSeblakSite/main/public/Logo/Logo.png" alt="Seblak Korea Mang Jay" class="w-56 h-56 sm:w-64 sm:h-64 md:w-80 md:h-80 object-contain drop-shadow-xl">
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="max-w-6xl mx-auto text-center">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            <div class="p-6 bg-red-50 rounded-2xl hover:shadow-lg transition hover:scale-105 border border-red-100">
              ...
              <h3 class="text-lg md:text-xl font-bold mb-2 text-red-700">Bumbu Asli</h3>
              <p class="text-sm md:text-base text-gray-600">Bumbu dan bahan asli Sunda bertemu dengan kondiment asal Korea.</p>
            </div>
            <div class="p-6 bg-orange-50 rounded-2xl hover:shadow-lg transition hover:scale-105 border border-orange-100">
              ...
              <p class="text-sm md:text-base text-gray-600">Tteokbokki, Odeng, dan Dumpling Keju.</p>
            </div>
            <div class="p-6 bg-yellow-50 rounded-2xl hover:shadow-lg transition hover:scale-105 border border-yellow-100">
              <div class="text-4xl mb-3">🔥🥵</div>
              <h3 class="text-lg md:text-xl font-bold mb-2 text-yellow-700">Nagih Pedasnya</h3>
              <p class="text-sm md:text-base text-gray-600">Pedasnya Nagih!</p>
            </div>
          </div>
        </div>
      </section>
